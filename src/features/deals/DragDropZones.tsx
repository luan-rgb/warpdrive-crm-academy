...
export const DROP_ZONES = [
  { id: "deal-zone-lost", label: "Perdido", tone: "text-red-600" },
  { id: "deal-zone-won", label: "Ganho", tone: "text-emerald-600" },
  { id: "deal-zone-move", label: "Mover", tone: "text-muted-foreground" },
] as const;
...
export function DragDropZones({ active }: { active: boolean }): React.ReactNode {
  ...
  return (
    <section
      aria-label="Ações ao soltar o negócio"
