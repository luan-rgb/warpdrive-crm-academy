...
# file (envs/aluno-*.env), replacing the value when the key is already there and appending it
# otherwise, then drop the retired NYLAS_* keys. Tenants provisioned from now on get them from
